...
const handleScroll = () => {
  // Toggle transparency based on scroll position matching the original site's behavior
  isTransparent.value = window.scrollY <= 10 ? 'true' : 'false'
}
